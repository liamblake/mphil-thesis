...
Theorem 2.2 of \cite{Sanz-AlonsoStuart_2017_GaussianApproximationsSmall}, summarised, is as follows.
...
We briefly consider the implications of our results on uncertain initial conditions from \Cref{sec:theory} on stochastic sensitivity.

The finite-time Lyapunov exponent (FTLE) was introduced in \Cref{sec:bkg_lcs} and provides a scalar measure of the local stretching about a trajectory in a dynamical system.

...
To further illustrate this point, we consider another example of a one-dimensional stochastic differential equation.
...
\begin{figure}
	...
	\end{tikzpicture}
	\caption{The splitting of a two-dimensional mean \(x\) and \(2\times 2\) covariance matrix \(\Sigma\) (in black) into 5 sigma points \(x^{(1)}, \dotsc, x^{(5)}\) (in blue), using the canonical set \cref{eqn:uhlman_sigma}.
...
\Cref{fig:sigma_points_ex} depicts the splitting of a mean and covariance matrix pair into 5 sigma points in two-dimensions, using the canonical set \cref{eqn:uhlman_sigma}.

...
\begin{figure}
	...
	\begin{subfigure}{\textwidth}
		...
		\caption{The mean \(x\) and covariance matrix \(\Sigma\) of the component is propagated forward by solving \cref{eqn:gauss_de_gmm} to obtain \(w_t\) and \(\Pi_t\) respectively.}
	\end{subfigure}
	\begin{subfigure}{\textwidth}
		\begin{tikzpicture}[scale=0.9]
			% Trajectory
	...
	\begin{subfigure}{\textwidth}
		\begin{tikzpicture}[scale=0.9]
			...
			\fill[white] (1,-13) circle[radius=1pt] node[anchor = east] {\(x\)};

			\fill[blue] (7,-13) circle[radius=1pt];
			\fill[blue, rotate around = {30: (7,-13)}] ($(7,-13)+(0:30pt and 70pt)$) circle[radius=1pt];
			\fill[blue, rotate around = {30: (7,-13)}] ($(7,-13)+(90:30pt and 70pt)$) circle[radius=1pt];
			\fill[blue, rotate around = {30: (7,-13)}] ($(7,-13)+(180:30pt and 70pt)$) circle[radius=1pt];
			\fill[blue, rotate around = {30: (7,-13)}] ($(7,-13)+(270:30pt and 70pt)$) circle[radius=1pt];

			% New trajectories
			\draw[black,  rotate around = {30: (7,-13)}] ($(7,-13)+(90:30pt and 70pt)$) .. controls (9,-14) and (12, -12) .. (14, -13);
			\draw[black,  rotate around = {30: (7,-13)}] ($(7,-13)+(0:30pt and 70pt)$) .. controls (9,-15) and (12, -12) .. (14, -14.5);
			\draw[black] (7,-13) .. controls (9,-15) and (12, -10) .. (16, -11.75);
			\draw[black,  rotate around = {30: (7,-13)}] ($(7,-13)+(180:30pt and 70pt)$) .. controls (9,-17) and (11, -15) .. (14, -18);
			\draw[black,  rotate around = {30: (7,-13)}] ($(7,-13)+(270:30pt and 70pt)$) .. controls (9,-17) and (11, -15) .. (12, -18);

			% Mapped points
			\fill[black, rotate around = {30: (7,-13)}] ($(14,-13)$) circle[radius=1pt];
			\fill[black, rotate around = {30: (7,-13)}] ($(14,-14.5)$) circle[radius=1pt];
			\fill[black] (16,-11.75) circle[radius=1pt];
			\fill[black, rotate around = {30: (7,-13)}] ($(14,-18)$) circle[radius=1pt];
			\fill[black, rotate around = {30: (7,-13)}] ($(12,-18)$) circle[radius=1pt];

			% Updated ellipses
			\draw[dashed, rotate around = {30: (7, -13)}, red] (14,-13) ellipse[x radius=30pt, y radius=70pt, rotate=75];
			\draw[dashed, rotate around = {30: (7, -13)}, red] (14,-14.5) ellipse[x radius=20pt, y radius=70pt, rotate=68];
			\draw[dashed, red] (16,-11.75) ellipse[x radius=10pt, y radius=50pt, rotate=70];
			\draw[dashed, rotate around = {30: (7, -13)}, red] (14,-18) ellipse[x radius=21pt, y radius=70pt];
			\draw[dashed, rotate around = {30: (7, -13)}, red] (12,-18) ellipse[x radius=10pt, y radius=50pt, rotate=15];

...
In the remainder of this chapter, we raise several discussion points on the possible implications and extensions of our work.
...
The term ``Markov'' refers to the assumption that the behaviour of the process at a given time only depends on the current state and nopt any of the preceding history.

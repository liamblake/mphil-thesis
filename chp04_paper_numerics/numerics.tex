...
The stochastic sensitivity field highlights the 3-dimensional structure of the vortices---compare \Cref{fig:gabc_S2} to the Poincar\`e sections in Figure 7 of \citet{DombreEtAl_1986_ChaoticStreamlinesABC}, which indicate the structure of the vortices due to the \emph{deterministic dynamics}.
The interior of the vortices are generally distinguished by a smaller stochastic sensitivity value, suggesting that even under small stochastic sensitivity these structures remain coherent.
This matches conclusions from the deterministic flow, where there interior of the vortices are `ordered' rather than chaotic; the stochastic sensitivity field provides a similar qualitative insight.

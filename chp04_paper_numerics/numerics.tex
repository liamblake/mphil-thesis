...
\Cref{sec:comput_s2} provides an initial and heuristic comparison between the stochastic sensitivity and finite-time Lyapunov fields, which does not appear in the submitted article.
...
The two fields are quantifying differnet aspects of the flow, however, and so can show differences; such examples are available in \citet{Balasuriya_2020_StochasticSensitivityComputable} (see Figure 3.7) and \citet{BadzaEtAl_2023_HowSensitiveAre} (compare Figures 1 and 5, and Figures 11 and 15).

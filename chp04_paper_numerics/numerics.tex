...
This structure is reflected in the stochastic sensitivity field, where the uncertainty is largest


When \(C = 1\) (\Cref{fig:gabc_S2_1}), vortex structures are formed and cause regions of chaotic mixing to emerge in the flow \citep{DombreEtAl_1986_ChaoticStreamlinesABC}.
